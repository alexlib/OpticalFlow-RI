#!/usr/bin/env python
"""
Run the optimized denseLucasKanade_Numba implementation on the Bits08 test case.
"""
...
def main():
    ...
    output_dir = 'denseLK_numba_optimized_results'
    ...
    # Save the flow field
    save_flow(U_out, V_out, os.path.join(output_dir, 'denseLK_numba_optimized.mat'))
    
    # Plot the flow field
    plot_flow_field(U_out, V_out, 'Dense Lucas-Kanade (Numba Optimized)', 
                   os.path.join(output_dir, 'denseLK_numba_optimized_flow.png'))
    
    # Plot parabolic profiles
    plot_parabolic_profiles(U_out, V_out, 'Dense Lucas-Kanade (Numba Optimized)',
                           os.path.join(output_dir, 'denseLK_numba_optimized_profiles.png'))
