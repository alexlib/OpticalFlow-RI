#!/usr/bin/env python
"""
Analyze parabolic images using OpenPIV and save results to a .mat file.
"""
...
def analyze_with_piv(frame_a, frame_b, window_size=64, overlap=32, dt=1.0, search_area_size=64):
    """
...
def save_results_to_mat(x, y, u, v, U, V, window_size, overlap, search_area_size, filename):
    """
    ...
    Args:
        ...
        window_size, overlap, search_area_size: PIV parameters
...
def main():
    ...
    save_results_to_mat(
        ...
        os.path.join(output_dir, 'piv_results.mat')
    )
