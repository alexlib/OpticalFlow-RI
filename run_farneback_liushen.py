#!/usr/bin/env python
"""
Run Farneback optical flow algorithm with Liu-Shen enhancement on BOS image pair
"""
...
def main():
    ...
    output_dir = 'farneback_liushen_results'
    ...
    # Plot results
    plot_results(U, V, "Farneback with Liu-Shen Enhancement", f"{output_base}.png")
