#!/usr/bin/env python
"""
Simple multipass PIV analysis down to 8-pixel windows.
"""
...
def analyze_with_piv(frame_a, frame_b, window_size=8, overlap=4, dt=1.0):
    """
    Analyze images using OpenPIV with small windows.
    ...
    """
    print(f"Analyzing with PIV (window_size={window_size}, overlap={overlap})...")
...
def main():
    ...
    # Use small windows for high resolution
    window_size = 8
    overlap = 4
    ...
    save_results_to_mat(
        ...
        filename=os.path.join(output_dir, 'piv_small_window_results.mat')
    )
